...
const StatsCard = ({headerTitle, total, currentMonthCount, lastMonthCount}:StatsProps) => {
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex items-center gap-2'>
                        <figure className='flex items-center gap-1'>
                            ...
                            />
                            <figcaption className={cn('text-small font-medium', isDecrement ? 'text-red-700': 'text-success-700')}>
